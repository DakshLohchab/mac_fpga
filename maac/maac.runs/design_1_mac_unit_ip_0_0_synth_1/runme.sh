...
HD_PWD='C:/Users/semic/Daksh_Lohchab/maac/maac.runs/design_1_mac_unit_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_mac_unit_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_mac_unit_ip_0_0.tcl
