...
#
# Script generated by Vivado on Thu May 28 21:43:08 IST 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : mac_unit_ip_0.sh
...
#
# Usage        : mac_unit_ip_0.sh
#                mac_unit_ip_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mac_unit_ip_0.sh [-rerun]
#                mac_unit_ip_0.sh [-reset_run]
#                mac_unit_ip_0.sh [-clean]
#                mac_unit_ip_0.sh [-reset_log]
#                mac_unit_ip_0.sh [-help]
#
...
export RDI_DATADIR="/home/dlohchab/Xilinx/2025.2/data"
...
# script info
echo -e "mac_unit_ip_0.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mac_unit_ip_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mac_unit_ip_0 xil_defaultlib.mac_unit_ip_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mac_unit_ip_0 -key {Behavioral:sim_1:Functional:mac_unit_ip_0} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/dlohchab/Xilinx/2025.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mac_unit_ip_0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mac_unit_ip_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mac_unit_ip_0.sh [-help]\n\
Usage: mac_unit_ip_0.sh [-step]\n\
Usage: mac_unit_ip_0.sh [-lib_map_path]\n\
Usage: mac_unit_ip_0.sh [-rerun]\n\
Usage: mac_unit_ip_0.sh [-reset_run]\n\
Usage: mac_unit_ip_0.sh [-clean]\n\
Usage: mac_unit_ip_0.sh [-reset_log]\n\
Usage: mac_unit_ip_0.sh [-keep_index]\n\
Usage: mac_unit_ip_0.sh [-noclean_files]\n\n\
