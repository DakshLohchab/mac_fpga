...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.mac_unit_ip_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.mac_unit_ip_0 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/dlohchab/projects/Verilog/mac/mac.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log mac_unit_ip_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
