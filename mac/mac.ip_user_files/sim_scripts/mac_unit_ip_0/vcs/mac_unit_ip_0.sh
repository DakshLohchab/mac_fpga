...
#                script (type 'mac_unit_ip_0.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.mac_unit_ip_0 xil_defaultlib.glbl -o mac_unit_ip_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./mac_unit_ip_0_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/dlohchab/projects/Verilog/mac/mac.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key mac_unit_ip_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc mac_unit_ip_0_simv.daidir vcs_lib c.obj)
